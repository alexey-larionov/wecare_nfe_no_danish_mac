...
table(variants.df$vep_VARIANT_CLASS,useNA = "always")
...
# Check number of variants per chromosome (X-chromosome will be excluded by PLINK later)
table(plink_map.mx[,1], useNA="always")
